          ...
          <div class="card-body">
            <ul class="task-list">
              <li class="task-item">
                ...
                <div class="task-check" role="checkbox" tabindex="0" aria-checked="false" aria-label="Mark Pre-op knee eval for James Rodriguez as complete" onclick="toggleTask(this)"><i class="fas fa-check"></i></div>
              ...
              <li class="task-item">
                <div class="task-priority high"></div>
                <div class="task-check" role="checkbox" tabindex="0" aria-checked="false" aria-label="Mark Fall risk assessment for Patricia Chen as complete" onclick="toggleTask(this)"><i class="fas fa-check"></i></div>
                <div class="task-content">
              ...
              <li class="task-item">
                ...
                <div class="task-check" role="checkbox" tabindex="0" aria-checked="false" aria-label="Mark Post-op hip progress for Linda Thompson as complete" onclick="toggleTask(this)"><i class="fas fa-check"></i></div>
                <div class="task-content">
